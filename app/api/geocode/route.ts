...
const demos = [
  ...
  { id: 'olympic-hall', name: '올림픽홀', address: '서울특별시 송파구 올림픽로 424 올림픽공원', latitude: 37.5141, longitude: 127.1274, countryCode: 'KR' },
  { id: 'kspo-dome', name: 'KSPO DOME', address: '서울특별시 송파구 올림픽로 424 올림픽공원', latitude: 37.5193, longitude: 127.1270, countryCode: 'KR' },
  { id: 'jamsil-arena', name: '잠실실내체육관', address: '서울특별시 송파구 올림픽로 25', latitude: 37.5161, longitude: 127.0767, countryCode: 'KR' },
