...
export const demoConcerts: Concert[] = [
  {
    ...
    status: 'attended',
    reviews: [
      { id: 'review-1', body: '바닷바람까지 공연의 일부 같았던 밤.', createdAt: '2026-08-08T22:30:00+09:00', rating: 4.5 },
      { id: 'review-2', body: '마지막 떼창을 오래 기억하고 싶다.', createdAt: '2026-08-09T09:10:00+09:00', rating: 5 },
    ],
  ...
  },
  {
    ...
    paidAmount: 205000,
    status: 'attended',
    reviews: [{ id: 'review-3', body: '처음 간 해외 페스티벌. 이동은 길었지만 첫 곡이 시작되자 모두 보상받았다.', createdAt: '2026-08-16T10:00:00+09:00', rating: 4.5 }],
