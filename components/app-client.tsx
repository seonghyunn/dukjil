  ...
  return <Dialog open onOpenChange={onOpenChange}><DialogContent className="max-h-[92vh] w-[calc(100vw-24px)] max-w-xl overflow-x-hidden overflow-y-auto border-black/10 bg-[#fbfaf6] p-0 text-[#1c1b18]">
    ...
    <div className="space-y-5 px-5 pb-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <DetailField label="예매처"><Input value={draft.bookingProvider} onChange={(event) => update('bookingProvider', event.target.value)} /></DetailField>
        <DetailField label="공연장"><Input value={draft.venue} onChange={(event) => update('venue', event.target.value)} /></DetailField>
